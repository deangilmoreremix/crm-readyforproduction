...
import { ArrowRight, BarChart3, Brain, Check, CheckCheck, ChevronRight, Clock, FileSearch, FileText, Link as LinkIcon, Mail, MessageSquare, Phone, PieChart, Play, Search, Star, Target, TrendingUp, User } from 'lucide-react';
